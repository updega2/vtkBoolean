	    ...
	    double surfaceid[2];
            int intersects =
              ...
              (triPts0[0], triPts0[1], triPts0[2],
               ...
               coplanar, outpt0, outpt1, surfaceid);
	    ...
	    int numCurrCells)
{
  ...
  surfaceMapper = static_cast<vtkLongArray*>
...
//	  std::cout<<"Intersecting Point!!"<<endl;
  ...
  this->GetTransform(transform,points);
...
void vtkIntersectionPolyDataFilter2::Impl::GetTransform(
